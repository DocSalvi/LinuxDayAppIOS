...
@property (readonly) GeoTag *next;
@property (readonly) GeoPoint coords;
@property (readonly) LongPoint absolutePos;
@property (readonly) Dimension size;
@property (readonly) Point refPoint;
...
@protocol GeoTagDelegate
// - (bool) isHit: (LongPoint) absolute: (int) scale;
// - (void) setCoords:   (double) lat: (double) lon;
// abstract
- (void) scaledPaint: (CGContextRef) context: (int) x: (int) y;
// abstract
// - (void) action; // (Context context, Point p);
@end
