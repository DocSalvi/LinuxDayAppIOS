...
@interface LinuxDayOSMViewController : UIViewController <UIGestureRecognizerDelegate, OSMBrowserDelegate, CoreLocationControllerDelegate>

@property (weak, nonatomic) IBOutlet UISlider *zoom;
@property (weak, nonatomic) IBOutlet OSMBrowser *osmBrowser;
@property (nonatomic, retain) LocationDelegate *CLController;
@property (nonatomic, retain) HereTag *here;
@property (assign) double homeLatitude;
@property (assign) double homeLongitude;
